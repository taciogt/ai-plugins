...
Plugins are versioned independently rather than versioning the Marketplace as a whole. A breaking change to `dev-workflow` advances its version without affecting `claude-productivity`.
